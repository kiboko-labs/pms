...
class ProductInventoryUnit extends BaseInventoryUnit
{
     ...
     *
     * @ORM\OneToOne(targetEntity="Kiboko\Bundle\PricingBundle\Entity\Product", mappedBy="inventoryUnit")
     ...
     *
     * @ORM\OneToMany(targetEntity="Kiboko\Bundle\PricingBundle\Entity\WarehouseInventoryUnit", mappedBy="productInventoryUnit")
     */
