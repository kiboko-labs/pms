...
class PriceList implements PriceListInterface, IdentifiableInterface, NamedInterface, ActivableInterface, DateIntervalInterface
{
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="Kiboko\Bundle\PricingManagementBundle\Entity\Price", mappedBy="priceList")
     */
    private $prices;
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kiboko\Bundle\PricingManagementBundle\Entity\Product", inversedBy="priceList")
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kiboko\Bundle\PricingManagementBundle\Entity\CustomerSegment", inversedBy="priceList")
