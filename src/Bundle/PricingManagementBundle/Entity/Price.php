...
class Price extends PriceAmount implements MutablePriceInterface, IdentifiableInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kiboko\Bundle\PricingManagementBundle\Entity\PriceList", inversedBy="prices")
     ...
     *
     * @ORM\OneToMany(targetEntity="Kiboko\Bundle\PricingManagementBundle\Entity\PriceHistory", mappedBy="price")
     */
