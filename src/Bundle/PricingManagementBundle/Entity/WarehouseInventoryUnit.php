...
class WarehouseInventoryUnit extends BaseInventoryUnit implements WarehouseAwareInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kiboko\Bundle\PricingManagementBundle\Entity\Warehouse", inversedBy="inventoryUnits")
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kiboko\Bundle\PricingManagementBundle\Entity\Product", inversedBy="inventoryUnits")
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kiboko\Bundle\PricingManagementBundle\Entity\ProductInventoryUnit", inversedBy="warehouseInventoryUnits")
